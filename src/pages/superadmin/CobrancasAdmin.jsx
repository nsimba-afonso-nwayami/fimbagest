...
export default function CobrancasAdmin() {
  ...
  // Dados de exemplo para a tabela de cobranças
  ...
  const sumarioCobrancas = [
    ...
    {
      titulo: "Em Aberto (Total)",
      valor: "45.2M Kz",
      icone: "fas fa-hourglass-half",
      cor: "text-blue-400",
    },
    {
      titulo: "Em Atraso (Total)",
      valor: "12.5M Kz",
      icone: "fas fa-triangle-exclamation",
      cor: "text-red-400",
    },
    {
      titulo: "Cobranças Pagas (Mês)",
      valor: "105.6M Kz",
  ...
  // Função auxiliar para formatar moeda (simulando kwanza angolano)
        ...
        <main className="mt-20 p-4 sm:p-6 space-y-8 sm:space-y-10">
          ...
          <div className="bg-blue-900/30 border border-blue-800 p-4 sm:p-6 rounded-xl shadow-lg backdrop-blur-md">
            <h3 className="text-lg sm:text-xl font-bold mb-4">
              Buscar e Filtrar Cobranças
            </h3>

            {/* Filtros de Condomínio, Status e Data */}
          ...
          <div className="overflow-x-auto bg-blue-900/30 border border-blue-800 rounded-xl shadow-xl backdrop-blur-md">
              ...
              <tbody>
                {dummyCobrancas.map((cobranca) => (
                  ...
                  >
                    ...
                    <td className="p-3 whitespace-nowrap">
                      {/* Simula a formatação de data de AAAA-MM-DD para DD/MM/AAAA */}
                    ...
                    <td className="p-3 text-center flex justify-center gap-3 sm:gap-4 text-base">
                      ...
                      <button className="text-red-400 hover:text-red-300" title="Cancelar/Excluir">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center p-3 sm:p-4 gap-4">
              <p className="opacity-70 text-xs sm:text-sm">
                Mostrando 1 a 5 de 1.842 registros
              </p>
