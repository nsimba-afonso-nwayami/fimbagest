    ...
    <>
      ...
      >
        ...
        <div className="text-center px-4 max-w-3xl mx-auto">
          ...
          <a
            href="/#solicitar-demo"
            className="
              inline-block mt-6 px-10 py-3 text-white font-semibold
              bg-violet-600 hover:bg-violet-700
              rounded-xl shadow-lg transition-all cursor-pointer
            "
          >
            Solicitar uma demo
          </a>
      ...
      >
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-3 gap-10">
          {/* ===================== BLOCO 1 ===================== */}
          <div className="bg-indigo-900/40 border border-indigo-800 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all">
          ...
          {/* ===================== BLOCO 2 ===================== */}
          <div className="bg-blue-900/40 border border-blue-800 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all">
            <div className="flex items-center gap-4 mb-6">
      ...
      >
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/10 shadow-lg hover:-translate-y-2 transition-all duration-300">
          ...
          {/*  Administradora acompanha tudo */}
          <div className="mt-16 bg-white/10 backdrop-blur-md p-10 rounded-3xl border border-white/10 shadow-xl max-w-4xl mx-auto text-center hover:-translate-y-2 transition-all duration-300">
      ...
      <section
        className="
    relative min-h-[90vh] py-16 px-6 md:px-16 text-white 
    bg-center bg-cover bg-no-repeat 
    bg-fixed md:bg-fixed
    overflow-hidden
  "
        style={{
          backgroundImage: `url(${SolicitarDemoImg})`,
        }}
      >
        {/* Overlay */}
      ...
      bg-blue-950/40 border border-blue-900 
      rounded-2xl p-6 md:p-8 shadow-xl backdrop-blur-md
    "
        >
          <form className="grid gap-6">
            <div>
              ...
              <input
                type="text"
                className="
            w-full p-3 rounded-lg bg-blue-950/60 border border-blue-900
          ...
          "
            ...
            <button
              className="
          mt-2 w-full py-3 rounded-xl font-bold bg-violet-600 
          hover:bg-violet-700 transition-all cursor-pointer
        "
            >
              Enviar
            </button>
          ...
          <div className="mt-6 text-center space-y-2 opacity-90 text-sm md:text-base">
            ...
            <p>
              <i className="fas fa-phone mr-2 text-violet-400"></i>
              Tel: +244 999999999
            </p>
            <p>
              <i className="fas fa-map-marker-alt mr-2 text-violet-400"></i>
              Av. Deolinda Rodrigues, 98 - Luanda
            </p>
          </div>
        </div>
      </section>
