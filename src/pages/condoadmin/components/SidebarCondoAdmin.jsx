      ...
      >
        ...
        <div className="flex-1">
          ...
          <nav className="space-y-4 text-lg">
            ...
            <Link
              to="/dashboard/condoadmin/moradores"
            ...
            {/* ITEM ADICIONADO */}
            <Link
              to="/dashboard/condoadmin/blocos"
              className="block p-3 rounded-lg hover:bg-gray-800/40 cursor-pointer"
            >
            ...
            {/* ITEM ADICIONADO */}
            <Link
              to="/dashboard/condoadmin/apartamentos"
              className="block p-3 rounded-lg hover:bg-gray-800/40 cursor-pointer"
            >
              <i className="fas fa-door-closed mr-3 text-violet-400"></i>
              Apartamentos
            </Link>
            <Link
              to="/dashboard/condoadmin/financeiro"
              className="block p-3 rounded-lg hover:bg-gray-800/40 cursor-pointer"
            >
            ...
            <Link
              to="/dashboard/condoadmin/comunicacao"
              className="block p-3 rounded-lg hover:bg-gray-800/40 cursor-pointer"
            >
            ...
            <Link
              to="/dashboard/condoadmin/reservas"
              className="block p-3 rounded-lg hover:bg-gray-800/40 cursor-pointer"
            >
            ...
            <Link
              to="/dashboard/condoadmin/ocorrencias"
              className="block p-3 rounded-lg hover:bg-gray-800/40 cursor-pointer"
            >
            ...
            <Link
              to="/dashboard/condoadmin/configuracoes"
              className="block p-3 rounded-lg hover:bg-gray-800/40 cursor-pointer"
            >
