    ...
    <div className="min-h-screen bg-gray-950 text-white flex">
      ...
      >
        ...
        <nav className="space-y-4 text-lg">
          {/* Item Ativo */}
          <a href="/dashboard/condoadmin/" className="block p-3 rounded-lg bg-gray-800 cursor-pointer border-l-4 border-violet-400 font-semibold">
            <i className="fas fa-gauge-high mr-3 text-violet-400"></i>
            Dashboard
          </a>
          <a href="/dashboard/condoadmin/moradores" className="block p-3 rounded-lg hover:bg-gray-800/40 cursor-pointer">
            <i className="fas fa-user-friends mr-3 text-violet-400"></i>
            Moradores 
          </a>
          <a href="/dashboard/condoadmin/financeiro" className="block p-3 rounded-lg hover:bg-gray-800/40 cursor-pointer">
            <i className="fas fa-file-invoice-dollar mr-3 text-violet-400"></i>
            Financeiro
          </a>
          <a href="/dashboard/condoadmin/comunicacao" className="block p-3 rounded-lg hover:bg-gray-800/40 cursor-pointer">
            <i className="fas fa-bell mr-3 text-violet-400"></i>
            Comunicação
          </a>
          <a href="/dashboard/condoadmin/reservas" className="block p-3 rounded-lg hover:bg-gray-800/40 cursor-pointer">
            <i className="fas fa-calendar-alt mr-3 text-violet-400"></i>
            Reservas
          </a>
          <a href="/dashboard/condoadmin/ocorrencias" className="block p-3 rounded-lg hover:bg-gray-800/40 cursor-pointer">
            <i className="fas fa-wrench mr-3 text-violet-400"></i>
            Ocorrências
          </a>
          <a href="/dashboard/condoadmin/configuracoes" className="block p-3 rounded-lg hover:bg-gray-800/40 cursor-pointer">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 bg-gray-900/30 border border-gray-800 p-6 rounded-xl shadow-lg backdrop-blur-md">
                <h3 className="text-xl font-bold mb-4 flex justify-between items-center">
                    Inadimplência Crítica <i className="fas fa-sack-xmark text-red-400"></i>
                </h3>
                <p className="text-sm opacity-70 mb-4">Unidades com pagamentos atrasados há mais de 30 dias.</p>
                    ...
                    <table className="min-w-full text-left text-sm">
                        ...
                        <tbody>
                            {dummyInadimplencia.map((item, index) => (
                                <tr key={index} className="border-b border-gray-800/40 hover:bg-gray-900/40">
                                    <td className="p-3 font-semibold text-violet-400">{item.unidade}</td>
            ...
            <div className="lg:col-span-1 bg-gray-900/30 border border-gray-800 p-6 rounded-xl shadow-lg backdrop-blur-md space-y-4">
                ...
                <div className="space-y-4">
                    <div className="p-3 bg-gray-800 rounded-lg border-l-4 border-blue-400">
                        <p className="font-semibold text-sm">Corte de Água Programado (Torre A)</p>
                    ...
                    <div className="p-3 bg-gray-800 rounded-lg border-l-4 border-yellow-400">
                        <p className="font-semibold text-sm">Manutenção Elevador Social</p>
                        <p className="text-xs opacity-60">Início: 15/12/2025</p>
                    </div>
                    <div className="p-3 bg-gray-800 rounded-lg border-l-4 border-green-400">
                        <p className="font-semibold text-sm">Assembleia Geral Extraordinária</p>
                        <p className="text-xs opacity-60">Agenda e documentos anexados.</p>
                    </div>
                </div>
